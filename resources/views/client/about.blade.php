...
<div class="bg-white min-h-screen font-sans pb-20">
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="text-center mb-16 max-w-4xl mx-auto">
            {{-- Tag: Đồng bộ text-2xl font-bold tracking-widest --}}
            ...
            {{-- Intro: text-xl (Lớn hơn text thường một chút để làm intro) --}}
            <p class="text-gray-500 text-xl leading-relaxed mb-6 font-medium">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
            <div class="text-center p-8 rounded-2xl bg-gray-50 hover:shadow-xl transition shadow-purple-100">
                {{-- Số liệu: text-4xl font-black --}}
                <div class="text-[#7d3cff] text-4xl font-black mb-2">10M+</div>
            ...
            <div class="text-center p-8 rounded-2xl bg-gray-50 hover:shadow-xl transition shadow-purple-100">
                <div class="text-[#7d3cff] text-4xl font-black mb-2">1K+</div>
        ...
        <div class="grid md:grid-cols-2 gap-12 mb-20 items-center">
            <div>
                {{-- Tiêu đề Section: text-3xl font-bold (Đã sửa từ font-black thành font-bold cho đồng bộ) --}}
            ...
            <div class="bg-purple-50 p-10 rounded-3xl border-2 border-purple-100">
                {{-- Tiêu đề Section: text-3xl font-bold --}}
                <h2 class="text-3xl font-bold text-gray-900 mb-6 text-center">Giá Trị Cốt Lõi</h2>
                <div class="space-y-6">
                    {{-- Item 1 --}}
                    <div class="flex gap-4">
                        <div class="w-12 h-12 shrink-0 bg-[#7d3cff] text-white rounded-lg flex items-center justify-center font-bold text-lg">01</div>
                        <div>
                            <h4 class="font-bold text-xl text-gray-900">Chất lượng hàng đầu</h4>
                            <p class="text-gray-500 text-base">Chúng tôi cam kết mang đến những sản phẩm chất lượng cao nhất với giá cả hợp lý.</p>
                        </div>
                    </div>
                    {{-- Item 2 --}}
                    <div class="flex gap-4">
                        <div class="w-12 h-12 shrink-0 bg-[#7d3cff] text-white rounded-lg flex items-center justify-center font-bold text-lg">02</div>
                        <div>
                            <h4 class="font-bold text-xl text-gray-900">Khách hàng là trung tâm</h4>
                            <p class="text-gray-500 text-base">Sự hài lòng của khách hàng là ưu tiên số một trong mọi hoạt động của chúng tôi.</p>
                        </div>
                    </div>
                    {{-- Item 3 --}}
                    <div class="flex gap-4">
                        <div class="w-12 h-12 shrink-0 bg-[#7d3cff] text-white rounded-lg flex items-center justify-center font-bold text-lg">03</div>
                        <div>
                            <h4 class="font-bold text-xl text-gray-900">Đổi mới không ngừng</h4>
                            <p class="text-gray-500 text-base">Luôn cập nhật xu hướng mới nhất và áp dụng công nghệ tiên tiến để phục vụ tốt hơn. </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-gray-900 rounded-[3rem] p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-purple-200">
            <div class="relative z-10">
                {{-- CTA Title: text-3xl md:text-4xl font-black --}}
