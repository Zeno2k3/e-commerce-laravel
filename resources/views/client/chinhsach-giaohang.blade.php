    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="mb-16">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-white hover:border-[#7d3cff]/20 transition-all">
                    ...
                    {{-- Tăng text-sm lên text-base cho dễ đọc --}}
                    <p class="text-gray-500 text-base leading-relaxed mb-4">Phù hợp cho các đơn hàng thông thường, thời gian giao hàng an toàn và đáng tin cậy.</p>
                    <span class="inline-block px-3 py-1 bg-gray-100 text-gray-600 rounded-lg text-sm font-bold">1-5 ngày làm việc</span>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border-2 border-[#7d3cff]/10 relative overflow-hidden group">
                    ...
                    <p class="text-gray-500 text-base leading-relaxed mb-4">Dành cho khách hàng cần nhận hàng gấp, ưu tiên xử lý và vận chuyển nhanh nhất.</p>
                    <span class="inline-block px-3 py-1 bg-purple-50 text-[#7d3cff] rounded-lg text-sm font-bold">2-3 ngày làm việc</span>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-white hover:border-[#7d3cff]/20 transition-all">
                    ...
                    <p class="text-gray-500 text-base leading-relaxed mb-4">Chỉ áp dụng tại Hà Nội và TP.HCM cho các đơn hàng đặt trước 14h hàng ngày.</p>
                    <span class="inline-block px-3 py-1 bg-gray-100 text-gray-600 rounded-lg text-sm font-bold">Trong vòng 24h</span>
                </div>
            </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-50">
                ...
                <div class="space-y-6">
                    {{-- Row items: Tăng text size lên để rõ ràng hơn --}}
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                        <div>
                            <p class="font-bold text-gray-800 text-lg">Hà Nội & TP.HCM</p>
                            <p class="text-sm text-gray-500">Phí: 30.000₫</p>
                        </div>
                        <span class="font-black text-[#7d3cff] text-lg">1-2 ngày</span>
                    </div>
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                        <div>
                            <p class="font-bold text-gray-800 text-lg">Các tỉnh thành lớn</p>
                            <p class="text-sm text-gray-500">Phí: 35.000₫</p>
                        </div>
                        <span class="font-black text-[#7d3cff] text-lg">2-3 ngày</span>
                    </div>
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                        <div>
                            <p class="font-bold text-gray-800 text-lg">Các tỉnh miền núi</p>
                            <p class="text-sm text-gray-500">Phí: 45.000₫</p>
                        </div>
                        <span class="font-black text-[#7d3cff] text-lg">3-5 ngày</span>
                    </div>
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                        <div>
                            <p class="font-bold text-gray-800 text-lg">Các đảo xa</p>
                            <p class="text-sm text-gray-500">Phí: 60.000₫</p>
                        </div>
                        <span class="font-black text-[#7d3cff] text-lg">5-7 ngày</span>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white p-12 rounded-[3rem] shadow-xl shadow-gray-200/50">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2 text-lg">Xác nhận</h5>
                    <p class="text-gray-500 text-base">Xác nhận đơn hàng và thông tin giao hàng trong vòng 2h.</p>
                </div>
                {{-- Bước 2 --}}
                <div class="text-center">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2 text-lg">Đóng gói</h5>
                    <p class="text-gray-500 text-base">Sản phẩm được đóng gói cẩn thận với vật liệu chất lượng cao.</p>
                </div>
                {{-- Bước 3 --}}
                <div class="text-center">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2 text-lg">Vận chuyển</h5>
                    <p class="text-gray-500 text-base">Đơn hàng được bàn giao cho đối tác vận chuyển chuyên nghiệp.</p>
                </div>
                {{-- Bước 4 --}}
                <div class="text-center">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2 text-lg">Giao hàng</h5>
                    <p class="text-gray-500 text-base">Nhận hàng tại địa chỉ yêu cầu và kiểm tra trước khi thanh toán.</p>
                </div>
            </div>
        </div>
