<footer class="bg-[#f8f9fa] pt-10 pb-6 border-t border-gray-150 mt-10">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                <h3 class="font-bold text-gray-900 uppercase tracking-wider mb-4 text-xl">Liên hệ</h3>
                <ul class="space-y-2">
                    <li class="flex items-start gap-4 text-gray-600 text-xl font-medium">
                        <i class="fa-solid fa-location-dot mt-1.5 text-gray-800 text-xl"></i>
                        <span>456 Đường ABC, Quận 1, TP. HCM</span>
                    </li>
                    <li class="flex items-center gap-4 text-gray-600 text-xl font-medium">
                        <i class="fa-solid fa-phone text-gray-800 text-xl"></i>
                        <span>0123 456 789</span>
                    </li>
                    <li class="flex items-center gap-4 text-gray-600 text-xl font-medium">
                        <i class="fa-solid fa-envelope text-gray-800 text-xl"></i>
                        <span>info@laravelshop.com</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="text-center">
            <p class="text-gray-600 text-base md:text-lg font-semibold uppercase tracking-tight">
                &copy; <span id="current-year"></span> LaravelShop.  Tất cả quyền được bảo lưu
            </p>
        </div>
    </div>
</footer>
