...
{{-- DỮ LIỆU GIẢ (Chỉ lấy sản phẩm có giảm giá để đúng tính chất trang Sale) --}}
@php
    $products = [
        [
...
<div class="bg-white min-h-screen font-sans pb-20">
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="text-center mb-16 max-w-4xl mx-auto">
            {{-- Tag Khuyến Mãi (Màu hồng nhạt + chữ đỏ như hình) --}}
            <span class="inline-block py-2 px-6 rounded-lg bg-red-100 text-red-500 font-bold text-lg mb-5 tracking-widest uppercase">
                <i class="fa-solid fa-percent mr-2"></i> Khuyến mãi lớn
            </span>

            {{-- Tiêu đề lớn --}}
            <h1 class="text-4xl md:text-6xl lg:text-6xl font-black text-gray-800 mb-4 tracking-tight leading-tight uppercase">
            ...
            {{-- Timer / Note (Thêm icon đồng hồ như hình) --}}
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 pb-6 border-b border-gray-100">
            ...
            {{-- Bên phải: Các nút lọc --}}
            <div class="flex flex-wrap gap-3">
                {{-- Nút Active: Giảm nhiều nhất (Màu tím như hình mẫu) --}}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 mb-12">
            @foreach($products as $product)
                {{-- Lưu ý: Đảm bảo component product-card hiển thị tốt discount tag --}}
