...
<div class="bg-[#f9fafb] min-h-screen font-sans pb-20">
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="text-center mb-16 max-w-3xl mx-auto">
            ...
            {{-- H1: Đồng bộ text-4xl md:text-5xl lg:text-5xl font-black --}}
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-50 flex gap-5 group hover:shadow-lg transition-all">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-base leading-relaxed">280 An Dương Vương, Phường Chợ Quán, TP. HCM</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-50 flex gap-5 group hover:shadow-lg transition-all">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-base">Hotline: 1900 6789</p>
                        <p class="text-gray-500 text-base">Zalo: 0123 456 789</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-50 flex gap-5 group hover:shadow-lg transition-all">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-base">info@laravelshop.com</p>
                        <p class="text-[#7d3cff] text-base font-semibold">support@laravelshop.com</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-50 flex gap-5 group hover:shadow-lg transition-all">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-base">T2 - T6: 8:00 - 22:00</p>
                        <p class="text-gray-500 text-base">T7 - CN: 9:00 - 21:00</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-24">
            <div class="text-center mb-12">
                {{-- H2: Đồng bộ text-3xl font-black (Hoặc font-bold đều được, giữ font-black cho nhấn mạnh) --}}
            ...
            <div class="max-w-4xl mx-auto space-y-4">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:border-[#7d3cff] transition-all">
                    ...
                    <p class="text-gray-600 pl-11 text-base">Bạn có thể theo dõi đơn hàng bằng cách đăng nhập vào tài khoản và vào mục 'Đơn hàng của tôi'.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:border-[#7d3cff] transition-all">
                    ...
                    <p class="text-gray-600 pl-11 text-base">Chúng tôi hỗ trợ đổi trả trong vòng 30 ngày kể từ ngày mua hàng với điều kiện sản phẩm còn nguyên tem mác.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:border-[#7d3cff] transition-all">
                    ...
                    <p class="text-gray-600 pl-11 text-base">Có, chúng tôi giao hàng toàn quốc với phí ship từ 30.000đ. Miễn phí ship cho đơn hàng trên 500.000đ.</p>
                </div>
            </div>
        </div>
