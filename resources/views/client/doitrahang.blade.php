    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 text-center border border-white">
                ...
                <p class="text-gray-600 font-bold">Thời gian đổi trả kể từ ngày nhận hàng</p>
            </div>
            <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 text-center border border-white">
                <div class="text-[#7d3cff] text-5xl font-black mb-2">Miễn phí</div>
                <p class="text-gray-600 font-bold">Không tính phí đổi trả cho lỗi từ nhà sản xuất</p>
            </div>
            <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 text-center border border-white">
                <div class="text-[#7d3cff] text-5xl font-black mb-2">100%</div>
                <p class="text-gray-600 font-bold">Cam kết hoàn tiền hoặc đổi sản phẩm mới</p>
            </div>
        </div>

        {{-- ĐIỀU KIỆN ĐỔI TRẢ (Bảng so sánh) --}}
        <div class="bg-white p-10 rounded-[3rem] shadow-xl shadow-gray-200/50 mb-16 border border-gray-50">
            <h2 class="text-3xl font-black text-gray-900 mb-10 text-center">Điều Kiện Đổi Trả</h2>
        ...
        {{-- QUY TRÌNH ĐỔI TRẢ --}}
        <div class="mb-16">
            <h2 class="text-3xl font-black text-gray-900 mb-10 text-center">Quy Trình Đổi Trả</h2>
            <div class="grid md:grid-cols-4 gap-6">
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-100 text-center relative">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2">Liên hệ yêu cầu</h5>
                    <p class="text-gray-500 text-xl">Gọi hotline hoặc gửi email với thông tin đơn hàng và lý do.</p>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-100 text-center relative">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2">Xác nhận yêu cầu</h5>
                    <p class="text-gray-500 text-xl">Shop xác nhận và cung cấp mã đổi trả trong vòng 2 giờ làm việc.</p>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-100 text-center relative">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2">Đóng gói hàng</h5>
                    <p class="text-gray-500 text-xl">Đóng gói sản phẩm theo hướng dẫn và gửi về địa chỉ shop.</p>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-100 text-center relative">
                    ...
                    <h5 class="font-bold text-gray-900 mb-2">Xử lý hoàn tiền</h5>
                    <p class="text-gray-500 text-xl">Hoàn tiền hoặc gửi sản phẩm thay thế trong vòng 3-5 ngày.</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-50">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-xs text-center text-gray-400 mt-4 italic">* Miễn phí đổi trả cho đơn hàng từ 1.000.000₫</p>
                </div>
            </div>
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-50">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between p-4 bg-purple-50 rounded-2xl">
                    ...
                    <p class="text-xs text-center text-gray-400 mt-4 italic">* Thời gian thực tế phụ thuộc vào ngân hàng của bạn</p>
                </div>
            </div>
        </div>
